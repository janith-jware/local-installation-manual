...
4. Run the following command in a server to launch the database server:
   `bash <(curl -s https://gist.githubusercontent.com/casi-devops-team/6ec4887a4b022a1d1818f5958a86147a/raw/95a098364571f2663e8d58883b118de0b45545b9/local-casi-database.sh)`
